    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
          ...
          if(result.equals("Valid")){
                ...
                OrderingAndResModule mod=new OrderingAndResModule(f,FullName,Ip,frame);      
    ...
    private String Verify(String UserID, String UserPass, String Ip) {
         ...
         Statement stmt = null;
            try{
                 ...
                 String sql="select fullname from StaffDetails where username='"+UserID+"' and password='"+UserPass+"' and (position='Staff' or position='Manager');";
