...
String email1= request.getParameter("email");
                ...
                ResultSet rs = st.executeQuery("select * from details where email='"+email1+"'");
                String email = "", name = "", security = "",ans="",address="",pin="",phn="",vil="",mandal="",dist="",state="";
...
<tr><th>Security Q:</th><td><%= security%></td></tr>
<tr><th>Answer:</th><td><%=ans%></td></tr>
<tr><th>Address:</th><td><%=address  %></td></tr>
<tr><th>Pincode:	</th><td><%= pin %></td></tr>
<tr><th>Phone no.:</th><td><%=phn%></td></tr>
<tr><th>village:</th><td><%=vil %></td></tr>
