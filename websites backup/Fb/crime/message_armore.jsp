...
<tr><th height="50" colspan="2"><div align="center" font-size:14px >MESSAGE</div></th></tr>
...
String sta="1";
			...
			Statement st1 = con1.createStatement();
                ResultSet rs = st.executeQuery("select * from message where sno='"+sn+"'");
                String email="",subject="",message="",date="";
...
message=rs.getString("message");
  ...
  st.executeUpdate("update message set status='"+sta+"'where sno='"+sn+"'");

                                    %>
<tr><th width=20>Email:</th><td ><%=email%></td></tr>
<tr><th width=20>Subject:	</th><td ><%=subject%></td></tr>
<tr><th width=20>Date:</th><td ><%= date%></td></tr>
<tr><th width=20>message:</th><td><%=message%></td></tr>
