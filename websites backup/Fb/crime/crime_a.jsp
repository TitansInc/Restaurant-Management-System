...
<tr><th height="50" colspan="2"><div align="center" font-size:14px >FIR</div></th></tr>
            ...
            try {
                ...
                String email = "", info = "", ai = "",ds="",dc="",datec="",cid;
                                        %>          
...
<th>complaintid</th>
  ...
  <%
      while (rs.next()) {
											 ...
											 datec = rs.getString("datec");
											   info= rs.getString("informant");
ai=rs.getString("addressinf");
                                              cid  = rs.getString("crimeid");
                                             			
                                                
                                                out.println("<tr>");
                                                out.println("<td>" + email+ "</td>");
                                                out.println("<td>" + info+ "</td>");
                                                out.println("<td>" +  ai+ "</td>");
                                                out.println("<td>" +  ds + "</td>");
												out.println("<td>"+ dc+ "</td>");
                                                out.println("<td>" + datec+ "</td>");
