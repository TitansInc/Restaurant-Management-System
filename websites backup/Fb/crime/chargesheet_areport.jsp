...
<tr><th height="50" colspan="2"><div align="center" font-size:14px >CHARGESHEET</div></th></tr>
   ...
   try {
     ...
     ResultSet rs = st.executeQuery("select * from chargesheet");
     String chargesheetno = "", nameofpolicesta = "", Date = "", firno="", district="", status="";
%>          
                                        
 <tr>
 <th >Chargesheet No.</th>
 <th >Name of Police</th>
 <th >Date</th>
 <th >FIR No.</th>
 <th >District</th>
 </tr>
...
<%
	...
	out.println("<tr>");
        out.println("<td>" + chargesheetno + "</td>");
        out.println("<td>" + nameofpolicesta + "</td>");
...
<td><a href="chargesheet_amore.jsp?firno=<%= firno %>">Viewmore</a></td>
</tr><%}%>
