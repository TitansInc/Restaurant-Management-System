...
<%
            ...
            try {
                ...
                String da1 = request.getParameter("date");
                String ti1 = request.getParameter("time");
                String type = request.getParameter("toi");
                String place1 = request.getParameter("poc");
                String for1 = request.getParameter("fl");
                String act = request.getParameter("select");
                String firno = request.getParameter("fno");
                String section1 = request.getParameter("section");
                String refe = request.getParameter("gdren");
                String infradd = request.getParameter("ia");
                ...
                String rect = request.getParameter("receivetime");
                String infrec = request.getParameter("inforeceived");
                String dispol = request.getParameter("dfps");
	String status ="o";
                Class.forName("com.mysql.jdbc.Driver").newInstance();
                Connection con1 = DriverManager.getConnection("Jdbc:mysql://localhost/crimefiles", "root", "");
                Statement st = con1.createStatement();
                st.executeUpdate("insert into fir values('"+district+"','"+da1+"','"+ti1+"','"+type+"','"+place1+"','"+for1+"','"+act+"','"+firno+"','"+section1+"','"+refe+"','"+infradd+"','"+passno+"','"+comno+"','"+police+"','"+rect+"','"+infrec+"','"+dispol+"','"+status+"')");
                out.println("FIR Saved successfully");
            } catch (Exception e) {
                out.println(e);
            }
%>
