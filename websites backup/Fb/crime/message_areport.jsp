...
.unread{background-color:#686868};
</style>
...
<tr><th height="50" colspan="2"><div align="center" font-size:14px >HotNews</div></th></tr>
            ...
            try {
                ...
                String email="",subject="",message="",date="",state="";int sn;
                                        %>          
...
<tr class="unread">
						...
						<td width=10><%= date%></td>
<td width=5><a href="message_armore.jsp?sno=<%= sn %>"> View Message</a></td>
